 ...
 */
public class ConstructorInvocationInTestCollectVisitor extends ASTVisitor {

    private ArrayList<String> constructorInvocationList;
    private String targetMethodName;
    private boolean isInTragetMethod;

    public ConstructorInvocationInTestCollectVisitor(String targetMethodName) {
        constructorInvocationList = new ArrayList<String>();
        this.targetMethodName = targetMethodName;
        this.isInTragetMethod = false;
    }

    public ArrayList<String> getConstructorInvocationList() {
